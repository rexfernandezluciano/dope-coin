...
import { AlertTriangle, Shield, Loader2, Plus } from "lucide-react";
...
export function TrustAssetModal({ isOpen, onClose, onSuccess, asset, trigger }: TrustAssetModalProps) {
  ...
  // If used with external control (trust requirement modal)
  if (isOpen !== undefined) {
